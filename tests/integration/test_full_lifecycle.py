...
def test_name_updates(conn, test_store):
    ...
    name, _, _ = _get_product(conn, item_code)
...
def test_full_item_lifecycle(conn, test_store):
    ...
    name, manufacturer, country = _get_product(conn, item_code)
    assert name == "Original Name"
    assert manufacturer is None
    assert country is None

    price, unit_price = _get_price(
        conn,
        chain_id,
        store_id_int,
        item_code,
    ...
    _, manufacturer, country = _get_product(conn, item_code)
